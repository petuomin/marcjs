...
var AlephSequentialReader = function(stream) {
  ...
  function parseFieldFromLine(lineStr) {
  	...
  	if (isFixFieldTag(tag) || tag === "LDR") {
	  	...
	  	// varfield
	  	var indicators = lineStr.substr(13,2);
		...
		var subfieldArray = Array.prototype.concat.apply([], subfields);
		return Array.prototype.concat([tag, indicators], subfieldArray);
	}
  }
  ...
  function isContinueFieldLine(lineStr) {
  	...
  	return (field[2] === "9" && (field[3] === "^" || field[3] === "^^"));
  }
...
exports.AlephSequentialReader = AlephSequentialReader;
